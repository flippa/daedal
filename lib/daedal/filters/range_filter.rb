module Daedal
  module Filters
    ...
    class RangeFilter < Filter
      ...
      attribute :timezone, Daedal::Attributes::QueryValue, required: false
      attribute :format, Daedal::Attributes::QueryValue, required: false
      ...
      def to_hash
        {range: {field => {gte: gte, lte: lte, lt: lt, gt: gt, format: format, timezone: timezone}.select {|k,v| !v.nil?}}}
      end
    end
  end
end
